...
const FilterModal = ({ handleFilterModal, verifyModalFilters }: any) => {
  return (
    ...
    // </div>
    <div className="absolute flex flex-col top-0 left-52 bg-white shadow-[5px_0_10px_rgba(0,0,0,0.3)] transform translate-x-full animate-slide-in rounded-b-3xl">
